import gym
from src.agents import ppo_agent, DQNagent, ppo_agent_stack_4
import argparse
import numpy as np
import torch
import random
...
def train(env, agent, args):
    ...
    for i in range(1, updates+1):
        ...
        agent.save_policy()
        np.save('episode_rewards_4', episode_rewards)
        np.save('avg_episode_rewards_4', avg_episode_rewards)
        np.save('episode_lengths_4', episode_lengths)
        np.save('avg_episode_lengths_4', avg_episode_lengths)
